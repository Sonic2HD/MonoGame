...
namespace Microsoft.Xna.Framework.Graphics.PackedVector
{
    ...
    public struct Bgr565 : IPackedVector<UInt16>, IEquatable<Bgr565>, IPackedVector
    {
        ...
        {
            return (UInt16) ((((int) (float)Math.Round(MathHelper.Clamp(x, 0, 1) * 31.0f) & 0x1F) << 11) |
                (((int) (float)Math.Round(MathHelper.Clamp(y, 0, 1) * 63.0f) & 0x3F) << 5) |
                ((int) (float)Math.Round(MathHelper.Clamp(z, 0, 1) * 31.0f) & 0x1F));
        }
