...
namespace Microsoft.Xna.Framework.Graphics.PackedVector
{
    ...
    public struct Bgra4444 : IPackedVector<UInt16>, IEquatable<Bgra4444>
    {
        ...
        {
            return (UInt16) ((((int) (float)Math.Round(MathHelper.Clamp(w, 0, 1) * 15.0f) & 0x0F) << 12) |
                (((int) (float)Math.Round(MathHelper.Clamp(x, 0, 1) * 15.0f) & 0x0F) << 8) |
                (((int) (float)Math.Round(MathHelper.Clamp(y, 0, 1) * 15.0f) & 0x0F) << 4) |
                ((int) (float)Math.Round(MathHelper.Clamp(z, 0, 1) * 15.0f) & 0x0F));
        }
